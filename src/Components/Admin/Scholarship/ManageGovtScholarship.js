...
function ManageGovtScholarship() {
  ...
  return (
    ...
    <div class="Head">
	    <div class="overlay">
        <h1 className="fw-bold fs-1 text-uppercase">Manage Govt Scholarship</h1>
      </div>
    </div>
    </div>
            ...
            <ol>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>NGO YLP (Youngs leaders Programme)</p>                        
                    </div>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>Fouji Foundation Scholarships</p>                        
                    </div>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>HEC NEED-BASED SCHOLARSHIPS</p>                        
                    </div>
...
export default ManageGovtScholarship;