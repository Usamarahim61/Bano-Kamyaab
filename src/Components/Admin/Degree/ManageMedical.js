...
function ManageMedical() {
  ...
  return (
    ...
    <div class="Head">
	    <div class="overlay">
        <h1 className="fw-bold fs-1 text-uppercase">Manage Pre Medical</h1>
      </div>
    </div>
    </div>
            ...
            <ol>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>Bachelor of Medicine and Bachelor of Surgery (MBBS)</p>                        
                    </div>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>Doctor of Pharmacy (D. Pharmacy)</p>                        
                    </div>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>Doctor of Physical Therapy (DPT)</p>                        
                    </div>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="col-9">
                      ...
                      <p>Doctor of Veterinary Medicine (DVM)</p>                        
                    </div>
