...
import { Emotionalquiz } from "./Question";
...
function Emotional() {
  ...
  return (
    ...
    <div class="Head">
	    <div class="overlay">
        <h1 className="fw-bold fs-1 text-uppercase">MANAGE Emotional Intelligence</h1>
      </div>
    </div>
    </div>
            ...
            <ol>
                ...
                <li className="d-flex border rounded-2 justify-content-between shadow-sm mt-3 px-4 py-2">
                    ...
                    <div className="d-flex justify-content-end col-1">
                        <Link><i  onClick={togglePopup} class="bi bi-pencil-square fs-5 "></i></Link>
